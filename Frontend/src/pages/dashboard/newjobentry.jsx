...
const NewJobEntry = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        const response = await axiosInstance.post("admin-form/", values, {
          headers: {
        ...
        >
          ...
          <Grid item xs={12} sm={6} md={4}>
            <FormControl sx={{ width: "100%" }}>
              <InputLabel id="job_model">Job Model</InputLabel>
              <Select
                id="job_model"
                name="job_model"
                onChange={formik.handleChange}
          ...
          <Grid item xs={12} sm={6} md={4}>
            <FormControl sx={{ width: "100%" }}>
              <InputLabel id="contract_type">Contract Type</InputLabel>
              <Select
                fullWidth
                id="contract_type"
                name="contract_type"
